...
def main_page(page: ft.Page):
    ...
    count = 0
    text_pressed = ft.Text("Pressed: 0 times", size=20) # добавил размер текста для наглядности

    def button_clicked(e): # добавил аргумент 'e', это стандарт для событий Flet
        nonlocal count
        count += 1
